...
export default function ResultSheetTable({ data }) {
  const classes = useStyles();

  function createData(name, matricNumber, level, department, course, mark, grade, status, link) {
    return { name, matricNumber, level, department, course, mark, grade, status, link };
  }
