    ...
    return ( 
        <MainDiv>
            ...
            <ContentDiv>
                ...
                <div>
                    <p style={{ fontFamily: 'Inter', fontStyle: 'normal', fontWeight: '600', fontSize: '14px', lineHeight: '22px', 
                    color: '#000000', letterSpacing: '0.02em', marginBottom: '30px'}}> Question 3/4 </p>

                    <p style={{ fontFamily: 'Manrope', fontStyle: 'normal', fontWeight: '500', fontSize: '14px', lineHeight: '28px', 
                    color: '#1E1E1E', letterSpacing: '0.02em', marginBottom: '30px'}}> 3.  The intercepts of a linear function f are at (k,0) and (o,m).If K m 0, which of the following <br /> describes the scope of f? </p>
