        ...
        <MainDiv>
            ...
            <ContentDiv>
                ...
                <p style={{ fontFamily: 'Inter', fontStyle: 'normal', fontWeight: '600', fontSize: '14px', lineHeight: '22px', 
                 color: '#000000', letterSpacing: '0.02em', marginBottom: '50px'}}> Present Examination</p>
                    <QTitle>
                        <Answer>
                            <p style={{ fontFamily: 'Inter', fontStyle: 'normal', fontWeight: '600', fontSize: '14px', lineHeight: '22px', 
                            color: '#1E1E1E', letterSpacing: '0.02em', marginBottom: '5px'}}>Biology Science</p>
                ...
                <div>
                    ...
                    color: '#1E1E1E', letterSpacing: '0.02em', marginBottom: '30px'}}> 1.  Which of the following Undergo cell division? </p>
