    ...
    return ( 
        <MainDiv>
            ...
            <ContentDiv>
                ...
                <div>
                    <p style={{ fontFamily: 'Inter', fontStyle: 'normal', fontWeight: '600', fontSize: '14px', lineHeight: '22px', 
                    color: '#000000', letterSpacing: '0.02em', marginBottom: '30px'}}> Question 2/4 </p>

                    <p style={{ fontFamily: 'Manrope', fontStyle: 'normal', fontWeight: '500', fontSize: '14px', lineHeight: '28px', 
                    color: '#1E1E1E', letterSpacing: '0.02em', marginBottom: '30px'}}> 2.  Which of the following undergo cell division </p>
                ...
                <div>
                    <div style={{display: 'flex', marginBottom: '20px'}}>
                      ...
                      color: '#1E1E1E', letterSpacing: '0.02em', marginLeft: '15px'}} > Prokaryotic cells</p>
                    </div>

                    <div style={{display: 'flex', marginBottom: '20px'}}>
                      <input type="radio" style={{accentColor: 'black'}} />
                      <p style={{ fontFamily: 'Inter', fontStyle: 'normal', fontWeight: '400', fontSize: '14px', lineHeight: '28px', 
                      color: '#1E1E1E', letterSpacing: '0.02em', marginLeft: '15px'}} > Eukaryotic cells</p>
                    </div>

                    <div style={{display: 'flex', marginBottom: '20px'}}>
                      <input type="radio" style={{accentColor: 'black'}} />
                      <p style={{ fontFamily: 'Inter', fontStyle: 'normal', fontWeight: '400', fontSize: '14px', lineHeight: '28px', 
                      color: '#1E1E1E', letterSpacing: '0.02em', marginLeft: '15px'}} > Both prokaryotic and eukaryotic cells</p>
                    </div>

                    <div style={{display: 'flex', marginBottom: '20px'}}>
                      <input type="radio" style={{accentColor: 'black'}} />
                      <p style={{ fontFamily: 'Inter', fontStyle: 'normal', fontWeight: '400', fontSize: '14px', lineHeight: '28px', 
                      color: '#1E1E1E', letterSpacing: '0.02em', marginLeft: '15px'}} > Prison cells</p>
                    </div>
